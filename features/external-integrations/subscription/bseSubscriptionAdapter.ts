/**
 * features/external-integrations/subscription/bseSubscriptionAdapter.ts
 *
 * Phase 9 Stage 3C: BSE Public Issue Cumulative Bidding Adapter (Revision 2.2).
 * Normalizes raw BSE bidding table data into canonical subscription structures.
 */
...
export class BseSubscriptionAdapter {
  public static readonly SOURCE_NAME = 'bse' as const;
  public static readonly BASE_URL = 'https://www.bseindia.com/markets/publicIssues/BiddingDetails_new.aspx';

  /**
   * Normalizes raw BSE cumulative bidding payload into a durable subscription observation.
   */
  public static normalize(params: {
    ...
    return {
      ...
      session_close_source: raw.isSessionClosed ? 'BSE Public Issue Session Close' : null,
    };
  }
}
